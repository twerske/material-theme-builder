...
const darkPrimaryText = 'rgba(black, 0.87)'
const lightPrimaryText = 'white'
...
// Alias for alternate spelling.
const blueGray = blueGrey;

export const paletteMap = {
  'mat.$red-palette': red,
  'mat.$pink-palette': pink,
  'mat.$purple-palette': purple,
  'mat.$deep-purple-palette': deepPurple,
  'mat.$indigo-palette': indigo,
  'mat.$blue-palette': blue,
  'mat.$light-blue-palette': lightBlue,
  'mat.$cyan-palette': cyan,
  'mat.$teal-palette': teal,
  'mat.$green-palette': green,
  'mat.$light-green-palette': lightGreen,
  'mat.$lime-palette': lime,
  'mat.$yellow-palette': yellow,
  'mat.$amber-palette': amber,
  'mat.$orange-palette': orange,
  'mat.$deep-orange-palette': deepOrange,
  'mat.$brown-palette': brown,
  'mat.$grey-palette': grey,
  'mat.$gray-palette': gray,
  'mat.$blue-grey-palette': blueGrey,
  'mat.$blue-gray-palette': blueGray,
}
